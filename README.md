...
* [7] W: Strategie doboru hiperparametrów (random search, grid search). Wprowadzenie do biblioteki [parsnip](https://tidymodels.github.io/parsnip/) do trenowania modeli. Projekt.
