...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 50, num.random.splits = 2L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# b57696d87f630f93e67f5582abb18616
