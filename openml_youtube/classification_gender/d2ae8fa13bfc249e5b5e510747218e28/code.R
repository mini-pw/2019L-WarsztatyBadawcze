...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 50, num.random.splits = 5L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# d2ae8fa13bfc249e5b5e510747218e28
