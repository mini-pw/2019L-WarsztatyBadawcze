...
lrn = makeLearner("classif.cvglmnet", par.vals = structure(list(lambda.min.ratio = 0, dfmax = 0, pmax = 0, exclude = 1, , predict.type = "prob")

#:# hash
#:# 4d632b7ec27a2db998cf38c46f1c299d
