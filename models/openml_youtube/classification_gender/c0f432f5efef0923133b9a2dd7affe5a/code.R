...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 50, num.random.splits = 3L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# c0f432f5efef0923133b9a2dd7affe5a
