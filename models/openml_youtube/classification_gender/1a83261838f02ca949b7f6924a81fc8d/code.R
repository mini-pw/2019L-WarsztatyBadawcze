...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 50, num.random.splits = 1L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 1a83261838f02ca949b7f6924a81fc8d
