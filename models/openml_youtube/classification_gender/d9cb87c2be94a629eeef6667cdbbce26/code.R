...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 100, num.random.splits = 1L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# d9cb87c2be94a629eeef6667cdbbce26
