...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 50, num.random.splits = 4L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 5d6fa6cb096089f69130ac7b7120d8c1
