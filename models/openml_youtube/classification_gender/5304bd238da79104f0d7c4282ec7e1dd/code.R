...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 100, num.random.splits = 5L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 5304bd238da79104f0d7c4282ec7e1dd
