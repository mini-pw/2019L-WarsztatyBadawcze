...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 100, num.random.splits = 2L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# a8ffd1349f6eccf1f28a1830392474c9
