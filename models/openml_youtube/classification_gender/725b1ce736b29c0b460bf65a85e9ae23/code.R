...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 100, num.random.splits = 3L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 725b1ce736b29c0b460bf65a85e9ae23
