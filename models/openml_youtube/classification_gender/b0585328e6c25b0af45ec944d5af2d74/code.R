...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 100, num.random.splits = 4L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# b0585328e6c25b0af45ec944d5af2d74
