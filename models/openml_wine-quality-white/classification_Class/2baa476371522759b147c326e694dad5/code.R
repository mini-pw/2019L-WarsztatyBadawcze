...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 500, num.random.splits = 1L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 2baa476371522759b147c326e694dad5
