...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 500, num.random.splits = 5L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 56a96a6662aa8c7bee3d8b6d39c7e9dd
