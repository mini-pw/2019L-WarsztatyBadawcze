...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 200, num.random.splits = 4L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 7c22544e540634b861e8c992645773fd
