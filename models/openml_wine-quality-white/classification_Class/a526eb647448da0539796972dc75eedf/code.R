...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 1000, num.random.splits = 5L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# a526eb647448da0539796972dc75eedf
