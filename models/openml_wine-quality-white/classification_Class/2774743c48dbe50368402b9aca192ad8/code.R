...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 1000, num.random.splits = 3L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 2774743c48dbe50368402b9aca192ad8
