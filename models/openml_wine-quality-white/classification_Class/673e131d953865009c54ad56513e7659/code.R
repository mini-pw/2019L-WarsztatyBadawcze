...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 1000, num.random.splits = 1L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 673e131d953865009c54ad56513e7659
