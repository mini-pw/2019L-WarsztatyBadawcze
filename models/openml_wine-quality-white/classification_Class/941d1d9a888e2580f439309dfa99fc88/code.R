...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 1000, num.random.splits = 4L), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# 941d1d9a888e2580f439309dfa99fc88
