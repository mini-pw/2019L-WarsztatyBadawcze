...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 100, num.random.splits = 5), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# eaf295a73a138583cbc978054e6be9b7
