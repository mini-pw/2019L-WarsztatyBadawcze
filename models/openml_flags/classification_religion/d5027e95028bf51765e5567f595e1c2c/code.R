...
lrn = makeLearner("classif.ranger", par.vals = structure(list(num.trees = 50, num.random.splits = 5), .Names = c("num.trees", , predict.type = "prob")

#:# hash
#:# d5027e95028bf51765e5567f595e1c2c
